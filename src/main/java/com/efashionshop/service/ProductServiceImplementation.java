...
import com.efashionshop.model.Category;
import com.efashionshop.model.Product;
import com.efashionshop.repository.CategoryRepository;
...
public class ProductServiceImplementation implements ProductService {
	...
	public Product createProduct(CreateProductRequest req) {
		...
		product.setQuantity(req.getQuentity());
	...
	public Page<Product> getAllProduct(String category, List<String> colors, List<String> sizes, Integer minPrice,
		...
		System.out.println(new PageImpl<>(pageContent,pageable,products.size()));
